                ...
                child: Column(
                  ...
                  SizedBox(height: 10),
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        final DateTime? dateTime = await showDatePicker(
                          ...
                          initialDate: from, // Adicionado aqui
                        );
                        if (dateTime != null) {
                          setState(() {
                            from = dateTime;
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        final DateTime? dateTime = await showDatePicker(
                          ...
                          firstDate: DateTime(2000),
                          lastDate: DateTime(3000),
                          initialDate: to, // Adicionado aqui
                        );
                        if (dateTime != null) {
                          setState(() {
                            to = dateTime;
                    ...
                    onPressed: () {
                      ...
                      final DateTime startDate = DateTime(from.year, from.month, from.day, 0, 0);
                      final DateTime endDate = DateTime(to.year, to.month, to.day, 0, 0);
                        AlarmService.setAlarm(
                          medicationName: medicationName,
                          startDate: startDate,
                          endDate: endDate,
                          timeOfDay: _selectedTime,
                          intervalInHours: _selectedInterval,
